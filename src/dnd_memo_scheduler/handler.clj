...
(defn init
  ...
  (timbre/set-config!
    ...
    {:path "dnd_memo_scheduler.log" :max-size (* 512 1024) :backlog 10})

  (if (env :dev) (parser/cache-off!))
  (timbre/info "dnd-memo-scheduler started successfully"))

(defn destroy
  "destroy will be called when your application
   shuts down, put any clean up code here"
  []
  (timbre/info "dnd-memo-scheduler is shutting down..."))
